...
<body>
   ...
   <div class="board_container">
      ...
      <div class="board_header">
         ...
         <form action="boardList.bo" class="search_form">
            <input class="search_bar" name="keyword" type="text" placeholder="제목 또는 내용을 검색할 수 있어요">
            <img src="${path}/resources/source/search.png" alt="" class="search_btn">
         </form>
         <c:choose>
         	...
         	<c:otherwise>         	
		         <button class="write_button" name="" onclick="writeAlert();">글쓰기</button>         	
         	</c:otherwise>
         </c:choose>
      </div>
	<script>
		function writeAlert(){
			alert("일반 고객으로 로그인한 회원만 글을 쓸 수 있습니다");
		}
	</script>
